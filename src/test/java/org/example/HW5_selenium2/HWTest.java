...
public class HWTest extends AbstractTest{
    ...
    void addFavorite(){
        ...
        WebElement iconClose = getDriver().findElement(By.cssSelector("button.fancybox-button.fancybox-quit-small"));
        iconClose.click();
    ...
    void addFavoriteByCard(){
        ...
        WebElement closeWindow = getDriver().findElement(By.cssSelector("button.fancybox-button.fancybox-quit-small"));
        closeWindow.click();
